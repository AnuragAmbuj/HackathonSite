...
<body>
	<nav class="light-blue lighten-1" role="navigation">
		<div class="nav-wrapper container">
			<a id="logo-container" href="#" class="brand-logo">Decoders
				Hackathon Admin Console: Announcer</a>
	...
	<!-- Body Below -->
	<div align="center">
		<form action="/announcementhandlerservlet" method="post">
			<table>
				<tr>
					<td>
			...
			<p align="center"><button type = "submit" class ="btn waves-effect waves-light">Announce<i class="material-icons right"></i></button>
		<button type="reset" value="Clear" class ="btn waves-effect waves-light">Clear</button></p>
		</form>
	</div>
